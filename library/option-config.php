		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields' => array (
					...
					array (
						'id' => 'open_menus_on_hover',
						'type' => 'switch',
						'title' => __('Open Top Menus on Hover', 'brew-framework'),
						'desc' => '',
						'default' => 1,
					),
			...
			$this->sections[] = array(
				...
				'fields' => array (
					...
					array (
						'id' => 'brewmenu',
						'type' => 'switch',
						'title' => __('Hide Brew Menu', 'brew-framework'),
						'desc' => 'Hide the button on the dashboard for the Brew menu.',
						'default' => 1,
					),
					array (
						'id'=>'featured',
